...
namespace backend.Application.Services
{
    public class TripParticipantService : ITripParticipantService
    {
        ...
        public async Task<ActionResult<IEnumerable<TripParticipantDTO>>> GetTripParticipants()
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while fetching trip participants.");
        ...
        public async Task<ActionResult<IEnumerable<TripParticipantDTO>>> GetTripParticipants(Guid tripId)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while fetching trip participants for trip ID {TripId}.", tripId);
                return new StatusCodeResult(StatusCodes.Status500InternalServerError);
            }
        }
        ...
        public async Task<ActionResult<TripParticipantDTO>> GetTripParticipant(Guid id)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while fetching the trip participant with ID {TripParticipantId}.", id);
                return new StatusCodeResult(StatusCodes.Status500InternalServerError);
            }
        }
        ...
        public async Task<IActionResult> PutTripParticipant(Guid id, TripParticipantDTO tripParticipantDTO)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while updating the trip participant with ID {TripParticipantId}.", id);
                return new StatusCodeResult(StatusCodes.Status500InternalServerError);
            }
        }
        ...
        public async Task<ActionResult<TripParticipantDTO>> CreateTripParticipant(Guid tripId, Guid participantId)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while creating a trip participant for trip ID {TripId} and participant ID {ParticipantId}.", tripId, participantId);
                return new StatusCodeResult(StatusCodes.Status500InternalServerError);
            }
        }
        ...
        public async Task<IActionResult> DeleteTripParticipant(Guid id)
        {
            ...
            {
                _logger.LogError(ex, "An error occurred while deleting the trip participant with ID {TripParticipantId}.", id);
                return new StatusCodeResult(StatusCodes.Status500InternalServerError);
            }
        }
    }
